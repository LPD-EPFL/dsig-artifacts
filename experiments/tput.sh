...
# for INGRESS_DELTA in {6950..6000..50}; do
    "$SCRIPT_DIR"/test-tput-pony-wots.sh base32 haraka 7 2 constant $INGRESS_DELTA -s 32
    "$SCRIPT_DIR"/test-tput-pony-wots.sh base32 haraka 7 2 exponential $INGRESS_DELTA -s 32
done
